  ...
  return (
    <div id='projects' className='max-w-[1040px] m-auto md:pl-20 p-4 py-16'>
      ...
      <div className='grid sm:grid-cols-2 gap-12'>
        ...
        <ProjectsItems img={'/RickAndMorty.png'} title='Rick & Morty' href={'https://rickandmortylucasbarcelo.netlify.app/'} linkGit={'https://github.com/lucasbarcelo11/rickandmorty'}/>
